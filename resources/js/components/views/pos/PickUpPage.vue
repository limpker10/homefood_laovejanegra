<template>
  <div class="flex-grow-1">
    <div class="d-flex align-center py-3">
      <div>
        <h2 style="color: #37474F">{{mesa.nombre_sucursal}} - Crear Pedido</h2>
      </div>
      <v-spacer></v-spacer>
      <v-tooltip bottom>
                            ...
                            <v-tabs-items v-model="tab">
                                ...
                                <v-card flat style="height:100%;margin-top: 10px;">
                                    ...
                                    <v-card-actions class="justify-end" >
                                        ...
                                        <v-btn color="warning" v-if="form.detalle.length>0"  @click="printCocina()">
 ...
 computed: {
  ...
  methods: {
        ...
        getOrdenes(){
            ...
            .then((response) => { 
                ...
                for (let index = 0; index < this.tabs_form.length; index++) {
                    ...
                    if(!isNaN(sumaTotal)){
                        this.tabs_form[index].subtotal = parseFloat(sumaTotal/1.18).toFixed(2);
        ...
        calcularTotal() {
            ...
            if(!isNaN(sumaTotal)){
                this.tabs_form[this.tab].subtotal = parseFloat(sumaTotal/1.18).toFixed(2);
        ...
        saveComprobante(){
            ...
            .then((response) => {
                ...
                if(response.data.success){
                    ...
                    // this.$router.push('/tablesSystem/'+this.id_sucursal);
                    // this.loading=false;
                    // this.$store.commit('LOADER',false);
        ...
        printCocina(){
            let id_orden=this.tabs_form[this.tab].id_orden;
            let headers_send = {"Access-Control-Allow-Origin": "*"};
            ...
            .then((response) => {
                ...
                axios.post(datos_print.url_print,  datos_print, { headers: headers_send})
                .then((response2) => {
